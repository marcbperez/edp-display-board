...
Display Port controller for eDP displays.
...
`kicad-project/edp-display-board.pro`.

```bash
git clone https://github.com/marcbperez/edp-display-board
cd edp-display-board
```
...
[issue-tracker]: https://github.com/marcbperez/edp-display-board/issues
